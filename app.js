...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    haeRotuUudelleen(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        t1, tekstiElementti, rotu, pos, rodunNimi, sanakirja, t2, url, $status, $async$temp1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              rodunNimi = pos !== 1 ? B.JSString_methods.substring$2(rotu, 6, pos) : rotu;
              $async$temp1 = B.C_JsonCodec;
              $async$goto = 2;
              return A._asyncAwait(A.HttpRequest_getString("https://dog.ceo/api/breed/" + rodunNimi.toLowerCase() + "/images/random"), $async$haeRotuUudelleen);
            case 2:
