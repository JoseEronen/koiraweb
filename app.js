...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = document;
              t2 = J.get$onClick$x(t1.querySelector("#hakunappi"));
              t3 = t2.$ti;
              t3._eval$1("~(1)?")._as(A.main__haeRotu$closure());
              type$.nullable_void_Function._as(null);
              A._EventStreamSubscription$(t2._target, t2._eventType, A.main__haeRotu$closure(), false, t3._precomputed1);
              t3 = J.get$onClick$x(t1.querySelector("#randomkuva"));
              t2 = t3.$ti;
              A._EventStreamSubscription$(t3._target, t3._eventType, t2._eval$1("~(1)?")._as(A.main__haeSatunnainen$closure()), false, t2._precomputed1);
              t2 = J.get$onClick$x(t1.querySelector("#kuva"));
              t3 = t2.$ti;
              A._EventStreamSubscription$(t2._target, t2._eventType, t3._eval$1("~(1)?")._as(A.main__haeSatunnainen$closure()), false, t3._precomputed1);
              t1 = J.get$onClick$x(t1.querySelector("#rotunappi"));
              t3 = t1.$ti;
              A._EventStreamSubscription$(t1._target, t1._eventType, t3._eval$1("~(1)?")._as(A.main__haeRotuUudelleen$closure()), false, t3._precomputed1);
              // implicit return
    ...
    haeRotuUudelleen(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        sanakirja, t2, url, $status, t1, tekstiElementti, rotu, pos, rodunNimi, rodunNimiPienella, $async$temp1;
      var $async$haeRotuUudelleen = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = document;
              tekstiElementti = t1.querySelector("#rotunappi");
              rotu = tekstiElementti.textContent;
              pos = J.lastIndexOf$1$as(rotu, " ");
              rodunNimi = pos !== 0 ? B.JSString_methods.substring$2(rotu, 6, pos) : rotu;
              rodunNimiPienella = rodunNimi.toLowerCase();
              A.haeUudelleenPienella(rodunNimiPienella);
              $async$temp1 = B.C_JsonCodec;
              $async$goto = 2;
              return A._asyncAwait(A.HttpRequest_getString("https://dog.ceo/api/breed/" + rodunNimiPienella + "/images/random"), $async$haeRotuUudelleen);
            case 2:
              // returning from await.
              sanakirja = $async$temp1.decode$2$reviver(0, $async$result, null);
              t2 = J.getInterceptor$as(sanakirja);
              url = t2.$index(sanakirja, "message");
              $status = t2.$index(sanakirja, "status");
              t2 = J.getInterceptor$($status);
              if (t2.$eq($status, "success")) {
                t1.querySelector("#kuva").setAttribute("src", url);
                J.set$text$x(tekstiElementti, "Rotu: " + A.StringExtension_capitalize(rodunNimi) + " ");
              } else if (t2.$eq($status, ""))
                J.set$text$x(tekstiElementti, "Ei tuloksia");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$haeRotuUudelleen, $async$completer);
    },
    haeUudelleenPienella(rodunNimiPienella) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        t1, tekstiElementti, pos, rodunNimi, sanakirja, t2, url, $async$temp1;
      var $async$haeUudelleenPienella = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = document;
              tekstiElementti = t1.querySelector("#rotunappi");
              pos = B.JSString_methods.lastIndexOf$1(rodunNimiPienella, " ");
              rodunNimi = pos !== 1 ? B.JSString_methods.substring$2(rodunNimiPienella, 0, pos) : rodunNimiPienella;
              $async$temp1 = B.C_JsonCodec;
              $async$goto = 2;
              return A._asyncAwait(A.HttpRequest_getString("https://dog.ceo/api/breed/" + rodunNimi + "/images/random"), $async$haeUudelleenPienella);
            case 2:
              // returning from await.
              sanakirja = $async$temp1.decode$2$reviver(0, $async$result, null);
              t2 = J.getInterceptor$as(sanakirja);
              url = t2.$index(sanakirja, "message");
              t2.$index(sanakirja, "status");
              t1.querySelector("#kuva").setAttribute("src", url);
              J.set$text$x(tekstiElementti, "Rotu: " + A.StringExtension_capitalize(rodunNimi) + " ");
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      return A._asyncStartSync($async$haeUudelleenPienella, $async$completer);
    },
    haeRotu(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        t1, osoite, sisalto, pos, rodunNimi, sanakirja, t2, url, $status, tekstiElementti;
      var $async$haeRotu = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = document;
              osoite = "https://dog.ceo/api/breed/" + type$.legacy_InputElement._as(t1.querySelector("#tekstikentta")).value.toLowerCase() + "/images/random";
              $async$goto = 2;
              return A._asyncAwait(A.HttpRequest_getString(osoite), $async$haeRotu);
            case 2:
              // returning from await.
              sisalto = $async$result;
              pos = B.JSString_methods.lastIndexOf$1(osoite, "/") - 7;
              rodunNimi = pos !== -1 ? B.JSString_methods.substring$2(osoite, 26, pos) : osoite;
      ...
      return A._asyncStartSync($async$haeRotu, $async$completer);
    },
    haeSatunnainen(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        tekstiElementti, pos, rodunNimi, url, t1, $async$temp1, $async$temp2;
      var $async$haeSatunnainen = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return A._asyncAwait(A.HttpRequest_getString("https://dog.ceo/api/breeds/image/random"), $async$haeSatunnainen);
            case 2:
              // returning from await.
              url = $async$temp1.$index$as($async$temp2.decode$2$reviver(0, $async$result, null), "message");
              t1 = document;
              t1.querySelector("#kuva").setAttribute("src", url);
              tekstiElementti = t1.querySelector("#rotunappi");
              t1 = J.getInterceptor$as(url);
              pos = t1.lastIndexOf$1(url, "/");
              rodunNimi = A._asStringS(pos !== -1 ? t1.substring$2(url, 30, pos) : url);
              J.set$text$x(tekstiElementti, "Rotu: " + A.StringExtension_capitalize(A.stringReplaceAllUnchecked(rodunNimi, "-", " ")) + " ");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$haeSatunnainen, $async$completer);
    },
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "main__haeRotuUudelleen$closure", "haeRotuUudelleen", 1);
    _static_1(A, "main__haeRotu$closure", "haeRotu", 1);
    _static_1(A, "main__haeSatunnainen$closure", "haeSatunnainen", 1);
  })();
  (function inheritance() {
    var _inherit = hunkHelpers.inherit,
      _inheritMany = hunkHelpers.inheritMany;
    _inherit(A.Object, null);
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A.StreamTransformerBase, A._StreamIterator, A._Zone, A.MapMixin, A.Codec, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider]);
